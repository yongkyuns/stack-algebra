...
Fit a quadratic to 40 noisy measurements, then follow a moving object from
imperfect position readings. The walkthroughs connect the code to figures and
output generated by executing the examples.
...
- [Guided tutorials](tutorials.md) introduce matrices, quadratic fitting, and a
  small Kalman filter through explained code, executed results, and experiments.
